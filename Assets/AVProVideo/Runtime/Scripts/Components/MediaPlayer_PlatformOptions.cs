...
#region PlatformOptions
		...
		public class OptionsApple: PlatformOptions
		{
			...
			public override bool IsUsingAudioCapture => _audioMode == AudioMode.Unity || 
														_audioMode == AudioMode.SystemDirectWithCapture;
		...
		public class OptionsAndroid : PlatformOptions, ISerializationCallbackReceiver
		{
			...
			public enum ChangeFlags : int
			{
				...
				AudioMode							= 1 << 4,
				GenerateMipmaps						= 1 << 5,
				AllowUnsupportedVideoTrackVariants	= 1 << 6,
				All = -1
			}
			...
			[SerializeField]
			private bool _allowUnsupportedVideoTrackVariants = false;
			public bool allowUnsupportedVideoTrackVariants
			{
				get { return _allowUnsupportedVideoTrackVariants; }
				set
				{
